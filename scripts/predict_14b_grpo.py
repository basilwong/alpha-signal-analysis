"""
14B GRPO Predictions: Merge adapter + vLLM inference.

Usage:
    modal run scripts/predict_14b_grpo.py
"""
...
app = modal.App("quantum-alpha-14b-grpo-predict")
...
ADAPTER_PATH = "/outputs/quantum-alpha-14b-grpo/checkpoint-184"
MERGED_OUTPUT = "/outputs/14b-grpo-merged"
EVAL_FILE = "/outputs/articles_eval.jsonl"
PREDICTIONS_FILE = "/outputs/predictions_14b_grpo.jsonl"
...
def predict():
    ...
    if not os.path.exists(MERGED_OUTPUT + "/config.json"):
        print("Merging 14B GRPO adapter...")
