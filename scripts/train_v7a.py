"""
V7a Training: SFT on V5 base only (881 examples with thinking traces, no bearish supplements).
Establishes baseline to compare against V4 and determine if thinking traces help/hurt.

Usage:
    modal run scripts/train_v7a.py
"""
...
app = modal.App("quantum-alpha-v7a-train")
...
TRAIN_FILE = "/outputs/quantum_alpha_train_v7a.jsonl"
OUTPUT_DIR = "/outputs/quantum-alpha-openreasoning-7b-v7a"
...
def train():
    ...
    print("=" * 60)
    print("V7a TRAINING: OpenReasoning-Nemotron-7B")
    print("V5 base only (881 examples, thinking traces, no bearish)")
    print("=" * 60)
