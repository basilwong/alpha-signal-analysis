"""
Fine-Tune Nemotron-3-Nano-4B on V4 Training Data

Uses Unsloth (confirmed day-zero support for Nemotron-3-Nano).
Same hyperparameters as MiniCPM-2B for fair comparison.

Usage:
    modal run scripts/train_nemotron4b.py
"""
...
app = modal.App("quantum-alpha-openreasoning7b-train")
...
OUTPUT_DIR = "/outputs/quantum-alpha-openreasoning-7b"
...
def train():
    ...
    print("=" * 60)
    print("QUANTUM ALPHA: OpenReasoning-Nemotron-7B Training")
    print("=" * 60)
    ...
    # Apply LoRA
    print("Applying LoRA (r=16, alpha=32)...")
